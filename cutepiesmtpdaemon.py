...
# Model tutorial: http://doc.qt.io/qt-4.8/modelview.html#2-1-a-read-only-table
# QTableView docs: http://doc.qt.io/qt-4.8/qtableview.html
# https://gist.github.com/MarshallChris/6019350
# SMTP servers: https://pymotw.com/2/smtpd/
# SMTPd threading: http://stackoverflow.com/questions/14483195/how-to-handle-asyncore-within-a-class-in-python-without-blocking-anything

# Type hinting in PyCharm: https://www.jetbrains.com/pycharm/help/type-hinting-in-pycharm.html

# original mailsink: http://code.activestate.com/recipes/440690-smtp-mailsink/

Make OSX app:
http://stackoverflow.com/questions/7827430/setting-mac-osx-application-menu-menu-bar-item-to-other-than-python-in-my-pyth
http://stackoverflow.com/questions/7404792/how-to-create-mac-application-bundle-for-python-script-via-python/7405367#7405367

FIX MENU BAR:
http://stackoverflow.com/questions/9500001/how-to-change-the-application-menu-name-in-pyqt4-on-os-x
You might try creating menubar like.
...
Icons compile: http://python.6.x6.nabble.com/Icons-and-Qt-resources-td1920078.html DONE!

TODO:
    ADD message count
    only parse and load body on itemselect, on open only parse headers DONE!
    MBOX LOADING VERY SLOW!!! find ways to optimize DONE!
    Plain-text messages: ADD WORD-WRAP (via CSS) DONE!

    mbox loader in separate thread with progress count with subjects preview

    CREATE NEW MBOX FILE
    TableView DOUBLE-CLICK action (ASSOCIATED EMAIL APP >> EML)
    - add SORTING by date/From columns

QItemDelegate Example:
http://www.saltycrane.com/blog/2008/01/pyqt4-qitemdelegate-example-with/


### IF importing EML message as MBOX then add missing From and time at the top ?? or parse message?
### and skip unixmbox parsing?

### text calendar content type processing???

### rename all handlers to start with 'on_'

TODO: ONLY SHOW HTML and skip text/plain (make option?)
TODO: register .eml mime type?

TODO: thread + progressbar with counter
Minimal Python Thread example with a progress bar
https://gist.github.com/mauriciodev/1118585

TODO: register mime type for .mbox, .eml .msgs
TODOTODO: CLEANUP files, especially those created by root
TODODODODO: PICKLE OBJECTS - DONE!
TODO: Add action for attachments: Open attachment as plain text DONE
EMAIL TEST: http://svn.python.org/projects/python/tags/r32/Lib/email/test/test_email.py
TODO, remember sorting mode DONE
TODODO: only recreate appstage if mailbox contents have changed, add dirty state DONE
TODO: show/hide toolbar
TODOODODODO: Convert attachments to ListView

TODODODOODODODO: Refactor, cleanup and reorganize
TODO: Create debian package

TODO: Restart scipt as sudo


RETINA DISPLAY issue: http://stackoverflow.com/questions/17211006/optimising-python-qt-apps-on-retina-displays
add to Info.plist:
...
"""
# to get mbox files google for: "filetype:mbox pipermail"
